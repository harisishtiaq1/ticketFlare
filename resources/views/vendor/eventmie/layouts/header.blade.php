<div id="navbar_vue"
    ...
    <div
        class="{{ \Str::contains(url()->current(), 'dashboard') ? 'dashboard-container' : 'container-fluid nav-header nav-header-classic menu-space header-position header-white shadow menu-fixed bg-white py-lg-2 px-lg-4 px-3' }}">
        <div class="row">
            <div class="col-md-12">
                <!-- GDPR -->
                ...
                <nav class="navbar navbar-expand-lg">
                    <a class="navbar-brand pr-5" href="{{ url('') }}">
                        <img src="/storage/{{ setting('site.logo') }}"
                            class="img-fluid mx-auto d-blocks {{ App::isLocale('ar') ? 'float-end' : 'float-start' }}"
                            alt="{{ setting('site.site_name') }}" style="height:40px;" />
                        {{-- <div class="my-2">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        ...
                        <a href="{{ route('eventmie.events_index') }}" class="btn btn-primary d-none d-lg-block">
