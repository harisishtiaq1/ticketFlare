...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="blogDropdown">
        ...
        @if (Auth::user()->hasRole('pos'))
            <li class="nav-item dropdown">
                <a class="dropdown-item" href="{{ route('pos.o_dashboard') }}">
                    <i class="fas fa-money-check-alt"></i> @lang('eventmie-pro::em.pos') @lang('eventmie-pro::em.dashboard')</a>
            </li>
        @endif

        @if (Auth::user()->hasRole('scanner'))
            {{-- <li class="nav-item dropdown">
                <a class="dropdown-item" href="{{ route('eventmie.ticket_scan') }}">
                    <i class="fas fa-qrcode"></i> @lang('eventmie-pro::em.scan') @lang('eventmie-pro::em.ticket')</a>
            </li> --}}
            <li class="nav-item dropdown">
                <a class="dropdown-item" href="{{ route('scanner.o_dashboard') }}">
                    <i class="fas fa-money-check-alt"></i> @lang('eventmie-pro::em.scanner') @lang('eventmie-pro::em.dashboard')</a>
            </li>
        @endif
        {{-- CUSTOM --}}
