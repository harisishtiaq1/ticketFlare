    ...
    <div class="modal-dialog modal-container modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" onclick="document.getElementById('review_modal').style.display = 'none';"
            ...
            <form method="POST" action="{{ route('reviews.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="textbox" class="form-control" id="review" name="review" onchange="review(event)"
                        value="{{ !empty($extra['user_reviews']) ? $extra['user_reviews']->review : '' }}">
                </div>
