            ...
            <div class="col-xl-12 col-md-12 col-12">
                <div class="bg-gray-200 rounded-3 px-3 mb-2">
                    <ul class="nav nav-lb-tab text-center w-space">
                        ...
                        @if (Auth::user()->hasRole('organiser'))
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{ name: 'stripe' }">

                                    @lang('eventmie-pro::em.stripe')
                                    <i class="fas fa-exclamation-circle text-danger" v-if="!store.state.stripe"></i>
                                    <i class="fas fa-check-circle text-primary" v-else></i>
                        ...
                        @if (Auth::user()->hasRole('organiser'))
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{ name: 'seller-info' }">

                                    @lang('eventmie-pro::em.seller_info')
                                    <i class="fas fa-exclamation-circle text-danger" v-if="!store.state.seller_info"></i>
                                    <i class="fas fa-check-circle text-primary" v-else></i>
                        ...
                        @if (Auth::user()->hasRole('organiser'))
                            <li class="nav-item">
                                <router-link class="nav-link" :to="{ name: 'mail-chimp' }">

                                    @lang('eventmie-pro::em.mailChimp_integration')
                                    <i class="fas fa-exclamation-circle text-danger"
                                        v-if="!store.state.mailChimp_integration"></i>
                                    <i class="fas fa-check-circle text-primary" v-else></i>
