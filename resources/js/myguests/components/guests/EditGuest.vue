<template>
    <div class="custom_model">
        <div class="modal show" v-if="edit_guest > 0">
            <div class="modal-dialog modal-lg w-100">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5">{{ trans('em.guest') }} {{ trans('em.details') }}</h1>
                    ...
                    <div class="modal-body">
                        <form ref="form" @submit.prevent="validateForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                <button type="submit" :class="{ 'disabled' : disable }"  :disabled="disable" class="btn btn-primary"><i class="fas fa-cash-register"></i> {{ trans('em.edit') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
