...
Vue.component(
    "tabs-component",
    require("../../../../../eventmie-pro/resources/js/events_manage/components/Tabs.vue")
        .default
);
...
const store = new Vuex.Store({
    ...
    mutations: {
        ...
        update(
            ...
            if (
                typeof v_repetitive_days !== "undefined" &&
                typeof v_sch_index !== "undefined"
            ) {
                state.v_repetitive_days[v_sch_index] = v_repetitive_days;
            }

            if (
                typeof v_repetitive_dates !== "undefined" &&
                typeof v_sch_index !== "undefined"
            ) {
