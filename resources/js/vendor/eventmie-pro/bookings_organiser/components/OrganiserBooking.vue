            ...
            <table class="table text-wrap">
                ...
                <tbody>
                    <tr v-for="(booking, index) in paginatedBookings" :key="index" >
                        ...
                        <!-- check booking expired or not -->
                        <td class="align-middle text-center" :data-title="trans('em.download')">
                        ...
                        <td class="align-middle text-center" :data-title="trans('em.actions')">

                        <div class="custom-dropdown" v-on:click="isOpen = isOpen === index ? null : index">
                            <a class="btn btn-primary"  href="#" role="button" id="courseDropdown2"><i class="fas fa-ellipsis-vertical" ></i> </a>
                                <ul  class="dropdownmenu shadow-lg" v-if="isOpen === index">
                                    <li>
                                    <a class="btn btn-sm btn-dark" :href="goto_route(booking.id)"><i class="fas fa-eye"></i> <span>{{ trans('em.view') }}</span></a>
                                    </li>
