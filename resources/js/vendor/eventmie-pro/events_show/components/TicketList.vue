            ...
            <div class="modal-dialog modal-xl model-extra-large">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-primary mx-lg-3" v-if="show_checkout_button">
                            <div class="text-sm d-flex flex-wrap justify-content-between">
                                ...
                                <div>
                                    ...
                                    <span class="fw-bold text-primary">
                                        <vue-countdown :time="checkoutTimer()" v-slot="{ minutes, seconds }">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            >
                                                ...
                                                <div style="overflow: auto;" class="break-flex" v-if="item.seatchart != null && item.seatchart.status > 0 && is_bulk <= 0 && item.t_soldout <= 0" >
                                                    <div class="break-flex mt-2 text-center " v-if="!register_user_id">
                                                        <button type="button"  @click="register_modal = 1; is_seatchart = true" class="btn btn-sm text-primary" >{{ trans('em.enter_guest_details') }} </button>
                                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <ul  class="list-group">
                                            ...
                                            <li class="list-group-item mb-3 rounded border-2" v-if="total > 0 && promocode_reward > 0">
                                                <span class="badge bg-success text-white"><strong>{{'-' + promocode_reward.toFixed(2)}} {{currency}}</strong></span>
                                                <h4>{{ trans('em.rewards') }}</h4>
                                            </li>
                                            <li class="list-group-item mb-3 rounded border-2" v-if="total > 0 && promocode_reward > 0">
                                                <span class="badge bg-success text-white"><strong>{{ (parseFloat(total) - parseFloat(promocode_reward)).toFixed(2) }} {{currency}}</strong></span>
                                        ...
                                        <div class="border-1 list-group-flush px-2">
                                            ...
                                            <div class="d-block my-3 pl-3" v-if="(parseFloat(total) - parseFloat(promocode_reward)).toFixed(2) <= 0">
                                                <div class="radio-inline">
                                                    <input id="free_order" name="payment_method" required type="radio" class="custom-control-input" checked v-model="payment_method" value="free">
                                            ...
                                            <div class="d-block my-3 pl-3" v-else-if="(parseFloat(total) - parseFloat(promocode_reward)).toFixed(2) > 0">
                                                ...
                                                <div class="radio-inline" v-if="is_admin <= 0 && is_paypal > 0 && is_bulk <= 0">
                                                    <input type="radio" class="custom-control-input" id="payment_method_paypal" required name="payment_method" v-model="payment_method" value="1" >
                                                ...
                                                <div class="radio-inline" v-if="is_admin <= 0 && isStripe > 0 && is_bulk <= 0 && is_stripe_direct <= 0" >
                                                    <input type="radio" class="custom-control-input" id="payment_method_stripe" required name="payment_method" v-model="payment_method" value="2" >
                                                ...
                                                <div class="radio-inline" v-if="is_admin <= 0 && isAuthorizeNet > 0 && is_bulk <= 0">
                                                    <input type="radio" class="custom-control-input" id="payment_method_authorize" required name="payment_method" v-model="payment_method" value="3" >
                                                ...
                                                <div class="radio-inline" v-if="is_admin <= 0 && is_bitpay > 0 && is_bulk <= 0">
                                                    <input type="radio" class="custom-control-input" id="payment_method_bitpay" required name="payment_method" v-model="payment_method" value="4" >
                                                ...
                                                <div class="radio-inline" v-if="is_admin <= 0 && is_stripe_direct > 0 && is_bulk <= 0">
                                                    <input type="radio" class="custom-control-input" id="payment_method_stripe_direct" required name="payment_method" v-model="payment_method" value="5" >
                                                ...
                                                <div class="radio-inline" v-if="is_admin <= 0 && is_bulk <= 0 && is_pay_stack > 0">
                                                    <input type="radio" class="custom-control-input" id="payment_method_paystack" required name="payment_method" v-model="payment_method" value="6" >
                                                ...
                                                <div class="radio-inline" v-if="is_admin <= 0 && is_bulk <= 0 && is_razorpay > 0">
                                                    <input type="radio" class="custom-control-input" id="payment_method_razorpay" required name="payment_method" v-model="payment_method" value="7" >
                                                ...
                                                <div class="radio-inline" v-if="is_admin <= 0 && is_bulk <= 0 && is_paytm > 0">
                                                    <input type="radio" class="custom-control-input" id="payment_method_paytm" required name="payment_method" v-model="payment_method" value="8" >
                                                    <label class="custom-control-label" for="payment_method_paytm">Paytm</label>
                                                </div>
                                                <div class="radio-inline" v-if="is_admin <= 0 && is_usaepay > 0">
                                                    <input type="radio" class="custom-control-input" id="payment_method_usaepay" required name="payment_method" v-model="payment_method" value="9" >
                                                ...
                                                <div class="radio-inline"
                                                    ...
                                                    <input type="radio" class="custom-control-input" id="payment_method_offline" required name="payment_method" v-model="payment_method" value="offline">
...
export default {
    ...
    methods: {
        ...
        checkTicketQuantity() {
            ...
            this.quantity.every(function(value, key){
                ...
                if(Number(value) <= 0 || value == '' || value == 'undefined'  || value == null  ){
                    ...
                    _this.checkout_start_time = null;
                    _this.checkout_end_time = null;
        ...
        checkoutTimer() {
            ...
            this.checkout_start_time  = moment().tz(local_tz).format('DD/MM/YYYY HH:mm:ss');
            this.checkout_end_time    = moment().tz(local_tz).add(5, 'minutes').format('DD/MM/YYYY HH:mm:ss');
    ...
    mounted() {
        ...
        setInterval(function() {
                ...
                console.log(_this.checkout_start_time < _this.checkout_end_time, _this.checkout_start_time, _this.checkout_end_time);
                if(_this.checkout_start_time > _this.checkout_end_time && _this.checkout_start_time != null && _this.checkout_end_time != null) {
                    _this.checkout_start_time = null;
                    _this.checkout_end_time = null;
                    window.location.reload();

                }
                _this.checkout_start_time = moment(_this.checkout_start_time, 'DD/MM/YYYY HH:mm:ss').add(1, 'seconds').format('DD/MM/YYYY HH:mm:ss');
