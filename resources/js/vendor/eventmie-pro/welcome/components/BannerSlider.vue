            ...
            <section>
                <div class="container-fluid p-0">
                    <div class="w-100 rounded-0 overlay-bg mt-lg-0 mt-8">
                        ...
                        <div class="banner-slider-form my-5 top-35 text-left ">
                            <div class="container">
                                <h1 class="text-white mb-0 fw-bold display-5 text-start w-50">
                                    {{ item.title }}
                                </h1>
                                <p class="text-white text-start py-lg-2">
                                    {{ item.subtitle }}
                                </p>
                                    ...
                                    <div v-if="demo_mode">
                                        ...
                                        <div class="px-2">
                                            <a
                                                ...
                                                target="_blank"
                                                href="https://eventmie-pro-docs.classiebit.com/docs/2.0/changelog/changes"
                                                ><i class="fas fa-book"></i> See
                                                What's New v2.0</a
                                            >
                                        </div>
                                    </div>
...
.banner-pagination .VueCarousel-pagination{
    bottom: 0%!important;
}
.top-35 {
  top: 25%;
