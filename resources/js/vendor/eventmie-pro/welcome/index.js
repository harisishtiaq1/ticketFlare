...
Vue.component(
    "event-listing",
    require("../common_components/EventListing").default
);
Vue.component("banner-slider", require("./components/BannerSlider").default);
Vue.component("categories-slider", require("./components/CategoriesSlider").default);
Vue.component("cities-slider", require("./components/CitiesSlider").default);
