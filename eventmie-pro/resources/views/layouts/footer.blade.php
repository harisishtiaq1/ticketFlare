    ...
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-3">
                ...
                <div>
                    <ul class="list-unstyled">
                        <li><a class="text-white lh-lg" href="{{ route('eventmie.page', ['page' => 'about']) }}">@lang('eventmie-pro::em.about')</a>
                        </li>
                        <li><a class="text-white lh-lg" href="{{ route('eventmie.events_index') }}">@lang('eventmie-pro::em.events')</a></li>
                        <li><a class="text-white lh-lg" href="{{ route('eventmie.get_posts') }}">@lang('eventmie-pro::em.blogs')</a></li>
                        <li><a class="text-white lh-lg" href="{{ route('eventmie.page', ['page' => 'terms']) }}">@lang('eventmie-pro::em.terms')</a>
                        </li>
                        <li><a class="text-white lh-lg" href="{{ route('eventmie.page', ['page' => 'privacy']) }}">@lang('eventmie-pro::em.privacy')</a>
                    </ul>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div>
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ 'https://www.facebook.com/' . setting('social.facebook') }}" target="_blank" class="text-white lh-lg">@lang('eventmie-pro::em.facebook')</a>
                        @endif
                        @if (setting('social.twitter'))
                        <li><a href="{{ 'https://twitter.com/' . setting('social.twitter') }}" target="_blank" class="text-white lh-lg">@lang('eventmie-pro::em.twitter')</a>
                        @endif
                        @if (setting('social.instagram'))
                        <li><a href="{{ setting('social.instagram') }}" target="_blank" class="text-white lh-lg">@lang('eventmie-pro::em.instagram')</a>
                        @endif
                        @if (setting('social.linkedin'))
                        <li><a href="{{ setting('social.linkedin') }}" target="_blank" class="text-white lh-lg">@lang('eventmie-pro::em.linkedin')</a>
                        @endif
                    </ul>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <div>
                    <ul class="list-unstyled">
                        <li><a href="{{ route('eventmie.contact') }}" class="text-white lh-lg">@lang('eventmie-pro::em.contact_send_message')</a></li>
                        <li><a href="{{ route('eventmie.contact') }}" class="text-white lh-lg">@lang('eventmie-pro::em.contact_find_us')</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-3">
